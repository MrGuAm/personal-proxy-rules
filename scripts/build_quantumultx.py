...
# > 个人 Sub-Store 节点订阅
https://raw.githubusercontent.com/Ruk1ng001/freeSub/main/clash.yaml, tag=节点合集, update-interval=172800, opt-parser=false, enabled=true
"""
...
def validate(path: Path) -> None:
    ...
    if "redacted-subscription-id/raw/quantumultx" not in text:
